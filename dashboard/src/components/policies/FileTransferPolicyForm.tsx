...
export default function FileTransferPolicyForm({ config, onChange }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-cs-sm border border-cs-indigo/30 bg-indigo-900/10 p-3 text-xs text-indigo-200">
          ...
          {(['create', 'modify', 'delete', 'move'] as const).map((event) => (
            ...
            >
              ...
              <div>
                ...
                <div className="text-cs-muted text-xs">{`Detect file ${event} operations at the destination`}</div>
              </div>
            </label>
          ))}
        </div>
        ...
        <div className="space-y-2">
          <label className="flex items-center gap-3 p-3 rounded-cs-sm border border-cs-hair bg-cs-panel-2 cursor-pointer hover:border-cs-hair transition-all">
            ...
            <div>
              ...
              <div className="text-cs-muted text-xs">Delete the arriving file at the destination and raise an alert</div>
            </div>
          </label>
